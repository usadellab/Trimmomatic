...
public class TrimStats {
	...
	public String processStatsSE(File statsSummary) throws IOException {
		...
		return "Input Reads: " + readsInput + " Surviving: " + readsSurvivingForward + " ("
				+ formatter.format(survivingForwardPercent) + "%) Dropped: " + dropped + " ("
				+ formatter.format(droppedPercent) + "%)";
	}
	...
	public String processStatsPE(File statsSummary) throws IOException {
		...
		if (statsSummary != null) {
			...
			statsSummaryStream
					.println("Forward Only Surviving Read Percent: " + formatter.format(survivingForwardPercent));
			statsSummaryStream.println("Reverse Only Surviving Reads: " + readsSurvivingReverse);
			statsSummaryStream
					.println("Reverse Only Surviving Read Percent: " + formatter.format(survivingReversePercent));
			statsSummaryStream.println("Dropped Reads: " + dropped);
			statsSummaryStream.println("Dropped Read Percent: " + formatter.format(droppedPercent));
		...
		return "Input Read Pairs: " + readsInput + " Both Surviving: " + readsSurvivingBoth + " ("
				+ formatter.format(survivingBothPercent) + "%) Forward Only Surviving: " + readsSurvivingForward + " ("
				+ formatter.format(survivingForwardPercent) + "%) Reverse Only Surviving: " + readsSurvivingReverse
				+ " (" + formatter.format(survivingReversePercent) + "%) Dropped: " + dropped + " ("
				+ formatter.format(droppedPercent) + "%)";
